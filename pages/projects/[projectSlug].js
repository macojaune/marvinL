			...
			{ProjectsData.map((project, index) => {
				return (
					<article key={project.url} className={`${project.url === projectSlug ? "" : "hidden"} flex flex-row bg-charcoal pb-16 md:pb-0`}>
						...
						<div className='w-full flex flex-col pr-6 md:pr-0 md:gap-6 md:flex-row'>
							<div className='w-full md:h-screen flex justify-start md:justify-center items-center py-12 md:py-24 '>
							...
							<div className='md:w-8/12 md:h-screen overflow-auto flex flex-col gap-5 md:gap-10 md:pr-24 md:py-24'> 
